...
Module:    DicomSeriesReadNiftiImageWrite.cxx
Language:  C++
...
This program read a DICOM series into a volume and then save this volume in NIFTI
file format.
...
//  to read a DICOM series into a volume and then save this volume in NIFTI
//  file format.
//
